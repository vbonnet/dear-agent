...
**LLMR-02** If no explicit provider is selected, then the package shall choose from the maintained provider registry without defaulting every route to Anthropic.
