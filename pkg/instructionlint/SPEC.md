...
**INSPOL-03** When governed Markdown, YAML, JSON, or hook scripts are parsed, the system shall inspect prose, inline code, every fenced language, structured string commands and permissions, and command-shaped code without trusting a language label or container format as a policy exemption.
