...
[`spec-governance/SPEC.md`](../SPEC.md), and the canonical
[`write-spec`](../skills/write-spec/SKILL.md) skill is a thin
workflow entry point that delegates here. The guide's
[contract model](../skills/write-spec/references/contract-model.md)
owns the classification vocabulary and its
[EARS and BDD guide](../skills/write-spec/references/ears-and-bdd.md)
owns the detailed authoring forms. This living guide is the canonical rule
owner; do not copy its rules into a skill or harness-specific guide.
...
ownership remains unclear, use [`audit-specs`](../skills/audit-specs/SKILL.md)
