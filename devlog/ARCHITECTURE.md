...
- Tools like `claude-session-manager` and `engram` implement automation
...
**Implications**:
- Workspace examples from oss/, [REDACTED_EMPLOYER]/, vida/
...
**Choice**: Use `~` instead of `/home/user/` and `{{DEVLOG_ROOT}}/` for variable root
