...
```markdown
### Lessons Learned (vida migration)
...
- **Example**: oss/ vs. [REDACTED_EMPLOYER]/ separation
...
- **Example**: [REDACTED_EMPLOYER]/vida/ nested in [REDACTED_EMPLOYER]/
...
- **Examples**: 9 repositories migrated (engram, vida, [REDACTED_EMPLOYER]-health-iac, grouper, aegis, ai-tools, beads, velvet, vpaste)
