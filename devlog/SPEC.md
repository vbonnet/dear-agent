...
- Implementation code (covered by specific tools like `claude-session-manager`, `engram`)
- Project-specific documentation (belongs in individual project repos)
- Automated tooling (separate from documentation)
- Session management functionality (covered by `claude-session-manager`)
...
- Real-world examples from oss/, [REDACTED_EMPLOYER]/, vida/ workspaces
...
**Examples**:
- 3 workspace pattern examples (oss/, [REDACTED_EMPLOYER]/, vida/)
...
- **Current**: 100% coverage for oss/, [REDACTED_EMPLOYER]/, vida/ workspaces
...
- claude-session-manager: Session management CLI
