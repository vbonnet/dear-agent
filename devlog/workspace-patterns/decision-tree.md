...
**Example**: oss/ (public) vs [REDACTED_EMPLOYER]/ (confidential)
- oss/: Full git tracking, public content
- [REDACTED_EMPLOYER]/: Metadata-only tracking, PII scrubbing, pre-commit hooks
...
**See**: [patterns.md#pattern-3-multi-workspace](patterns.md#pattern-3-multi-workspace), [examples.md#example-2-multi-workspace](examples.md#example-2-multi-workspace-oss--[REDACTED_EMPLOYER])
...
**Example**: [REDACTED_EMPLOYER]/vida/ (Vida product within [REDACTED_EMPLOYER] workspace)
- Parent: [REDACTED_EMPLOYER]/ (company workspace)
- Sub-workspace: vida/ (Vida product)
- .gitignore excludes vida/ from parent git
- Parent README.md documents vida/
...
4. When sub-workspace grows: Add vida/README.md and vida/AGENTS.md
...
**See**: [patterns.md#pattern-4-sub-workspace](patterns.md#pattern-4-sub-workspace), [examples.md#example-3-sub-workspace](examples.md#example-3-sub-workspace-[REDACTED_EMPLOYER]vida)
...
- Multi-Workspace + Sub-Workspace: ✅ ([REDACTED_EMPLOYER]/ workspace with vida/ sub-workspace)
- Mono-Repo + Multi-Workspace: ✅ (oss/ is mono-repo, [REDACTED_EMPLOYER]/ is separate workspace)
