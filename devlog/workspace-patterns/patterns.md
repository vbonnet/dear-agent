...
**[REDACTED_EMPLOYER]/ (confidential)**:
```
[REDACTED_EMPLOYER]/
...
**How enforced?**
- [REDACTED_EMPLOYER] pre-commit hooks prevent content commits
...
**Security mechanisms** ([REDACTED_EMPLOYER]/):
...
- [REDACTED_EMPLOYER]/README.md (255 lines): Comprehensive security policy, workflow, PII scrubbing guidelines
...
- Line 40: "vida/ - ❌ NOT TRACKED (Vida product sub-workspace)"
- Line 47: "vida/ - Vida product development (distinct sub-workspace)"
- .gitignore policy inherited from parent

**Why nested?**
- Vida is [REDACTED_EMPLOYER] product → logical grouping
- Different tracking policy (vida/ not tracked in [REDACTED_EMPLOYER] git)
- Product-specific area within company workspace

**Why not separate workspace?**
- Logical relationship (Vida is [REDACTED_EMPLOYER] product)
...
- ✅ Example: oss/ is mono-repo, [REDACTED_EMPLOYER]/ is separate workspace
- Use case: Multiple independent workspaces, each using mono-repo internally

**Multi-Workspace + Sub-Workspace**:
- ✅ Example: [REDACTED_EMPLOYER]/ has vida/ sub-workspace
...
**Example 1**: oss/ (mono-repo) + [REDACTED_EMPLOYER]/ (multi-workspace) + vida/ (sub-workspace)
- oss/: Mono-repo for engram-research
- [REDACTED_EMPLOYER]/: Separate workspace for confidential work
- vida/: Sub-workspace within [REDACTED_EMPLOYER]/ for Vida product
...
| Multi-Workspace | Independent workspaces | oss/ vs [REDACTED_EMPLOYER]/ | Confidentiality, team boundaries |
| Sub-Workspace | Nested workspace | [REDACTED_EMPLOYER]/vida/ | Product area within workspace |
