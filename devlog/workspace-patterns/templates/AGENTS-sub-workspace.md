...
- `[WORKSPACE_NAME]` → "vida" (sub-workspace display name)
- `[workspace]` → "vida" (sub-workspace directory name)
- `[parent]` → "[REDACTED_EMPLOYER]" (parent workspace name)
...
- Real examples: [examples.md](../examples.md#example-3-sub-workspace-[REDACTED_EMPLOYER]vida)
