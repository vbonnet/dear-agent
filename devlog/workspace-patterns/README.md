...
Real workspace walkthroughs (oss/, [REDACTED_EMPLOYER]/, vida/) showing each pattern in practice.
...
- Example 2: Multi-Workspace (oss/ vs [REDACTED_EMPLOYER]/)
...
- Common scenarios (oss/, [REDACTED_EMPLOYER]/, vida/)
- Troubleshooting
...
A: **Sub-Workspace**. It's nested within [REDACTED_EMPLOYER]/. The fact that [REDACTED_EMPLOYER]/ is Multi-Workspace (separate from oss/ due to confidentiality) doesn't change vida/'s pattern.
