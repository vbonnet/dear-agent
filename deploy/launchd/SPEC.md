...
**DECL-LAUNCHD-05** When the token-refresher LaunchAgent is configured for cadence mode, the system shall direct its audit writes to a dedicated path separate from the ordinary CLI default audit path.
