...
| [autonomous-merge](autonomous-merge.ai.md) | Agents mark ready, review, and merge their own PRs — except security/product/money/governance/control-surface, which a human marks ready and merges. |
