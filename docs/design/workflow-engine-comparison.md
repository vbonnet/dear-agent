...
**Related:**
[ADR-010 — Workflow Engine as Substrate-Quality Work-Item Layer](../adr/ADR-010-workflow-engine-architecture.md),
...
| C4 | Must have an audit trail per state transition (substrate property). | [ADR-010](../adr/ADR-010-workflow-engine-architecture.md), which absorbed ADR-009's work-item distinction. |
...
- [ADR-010 — Workflow Engine as Substrate-Quality Work-Item Layer](../adr/ADR-010-workflow-engine-architecture.md), including the former ADR-009 work-item decision
- [Workflow Engine Operator Guide](../workflow-engine.md)
