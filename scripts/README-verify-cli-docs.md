...
chmod +x ~/src/ws/oss/repos/ai-tools/main/scripts/verify-cli-docs.sh

# Add to PATH (optional)
export PATH="$PATH:~/src/ws/oss/repos/ai-tools/main/scripts"
```
...
[INFO] Docs root: /home/user/.claude/plugins/cache
...
[INFO] Checking csm
[INFO] Extracting flags from /home/user/.claude/plugins/cache/.../csm-assoc.md
...
- Project: `~/src/ws/oss/swarm/projects/cli-docs-sync-audit/`
