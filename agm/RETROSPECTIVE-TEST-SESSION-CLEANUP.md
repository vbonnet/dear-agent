...
```
ok  	github.com/vbonnet/ai-tools/agm/cmd/agm	1.001s
ok  	github.com/vbonnet/ai-tools/agm/internal/backup	(cached)
ok  	github.com/vbonnet/ai-tools/agm/internal/conversation	(cached)
ok  	github.com/vbonnet/ai-tools/agm/test/integration/lifecycle	0.680s
