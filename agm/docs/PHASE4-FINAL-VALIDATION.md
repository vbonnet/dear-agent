...
**Expected Output**:
```
ok      github.com/vbonnet/dear-agent/agm/cmd/agm                    4.5s
ok      github.com/vbonnet/dear-agent/agm/internal/...               (all ok)
ok      github.com/vbonnet/dear-agent/agm/test/integration          363.9s  ✅ (was FAIL, now ok)
ok      github.com/vbonnet/dear-agent/agm/test/...                  (all ok)
```
