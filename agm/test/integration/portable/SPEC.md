...
**IPORT-01** When the integration graph runs without host credentials or services, the suite shall execute credential-free conformance for every active harness.
