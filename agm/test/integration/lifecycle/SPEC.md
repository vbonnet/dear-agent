...
**LIFEI-08** When the legacy lifecycle package skips unavailable end-to-end infrastructure, the system shall not suppress the independently packaged isolated Codex lifecycle.
