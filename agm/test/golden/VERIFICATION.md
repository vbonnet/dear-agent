...
PASS
ok  	github.com/vbonnet/dear-agent/agm/internal/session	0.017s
```
...
PASS
ok  	github.com/vbonnet/dear-agent/agm/internal/config	0.025s
```
...
ok  	github.com/vbonnet/dear-agent/agm/internal/session	0.468s
ok  	github.com/vbonnet/dear-agent/agm/internal/config	0.085s
```
