...
# RELATED-SPEC: wayfinder/cmd/wayfinder-session/internal/resume/SPEC.md
...
Feature: Wayfinder lifecycle guardrails
  Wayfinder archive, resume, workspace, and review packages should carry
  ...
  Scenario Outline: Wayfinder lifecycle packages declare SPEC coverage
    ...
    Examples:
      ...
      | wayfinder/cmd/wayfinder-session/internal/resume    |
