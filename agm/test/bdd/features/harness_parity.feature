...
Feature: Harness parity
  ...
  Scenario: Failed Codex resume is rolled back before success effects
    ...
    And authoritative session renames should reconcile ambiguous tmux and storage replies, reject stale identity revisions, and compensate tmux after storage conflicts
