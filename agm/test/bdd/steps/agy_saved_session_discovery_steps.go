...
func agyCreateIdentityCorrelationShouldRejectStaleProviderState(ctx context.Context) error {
	return requireAgySavedSessionBehavior(ctx,
		...
		"TestFindLatestForWorkspaceCanonicalizesSymlinkAlias",
