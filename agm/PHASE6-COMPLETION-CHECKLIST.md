...
**Sample packages**:
```
ok  	github.com/vbonnet/dear-agent/agm/cmd/agm
ok  	github.com/vbonnet/dear-agent/agm/internal/dolt
ok  	github.com/vbonnet/dear-agent/agm/internal/session
ok  	github.com/vbonnet/dear-agent/agm/test/integration
ok  	github.com/vbonnet/dear-agent/agm/test/bdd
ok  	github.com/vbonnet/dear-agent/agm/test/e2e
```
