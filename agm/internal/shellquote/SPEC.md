...
**AGM-SHELLQUOTE-01** When `Quote` receives any string, the system shall produce one single-quoted POSIX shell word whose parsed value is byte-for-byte identical to the input.
