...
func ListOps() *ListOpsResult {
	ops := []OpInfo{
		...
		{Name: "set_completion_relay_target", Description: "Set the live Dispatch/AGM session that receives watcher completion relays.", Category: "mutation", Surface: "cli,mcp"},
