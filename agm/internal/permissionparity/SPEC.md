...
**APP-16** When a Pi project hook errors or times out after emitting stderr or advisory context, the system shall fail closed and report the execution failure ahead of partial hook output instead of presenting that output as the rejection reason.
