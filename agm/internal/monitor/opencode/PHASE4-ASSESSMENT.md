...
ok  	github.com/vbonnet/dear-agent/agm/internal/monitor/opencode	14.734s	coverage: 88.4% of statements
```
...
ok  	github.com/vbonnet/dear-agent/agm/internal/daemon	0.109s
```
