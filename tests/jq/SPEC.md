...
**JQF-08** When a jq program does not terminate, the gate shall abort that case on a deadline rather than block the suite, and the gate shall resolve the repository root without invoking Git.
