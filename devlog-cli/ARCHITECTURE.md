...
│   workspace.go  │ │  output.go  │ │ errors.go  │
│  - LoadWorkspace│ │  - Writer   │ │ - Wrap     │
│  - GetRepoPath  │ │  - Success  │ │ - WrapPath │
│  - GetWorktree  │ │  - Error    │ │ - Is/As    │
└────────┬────────┘ └─────────────┘ └────────────┘
         │
         │ uses
         │
...
│    config/      │
│  ┌──────────┐  │
│  │config.go │  │ (Types, Validation)
│  │loader.go │  │ (Discovery, Loading)
│  │merge.go  │  │ (Additive Merge)
│  └──────────┘  │
└────────┬────────┘
         │
         │ path resolution
