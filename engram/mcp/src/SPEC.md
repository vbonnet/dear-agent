...
**ENGRAM-MCP-TS-03** When the Wayfinder status tool reads a project, the system shall validate canonical schema-2.0 YAML and shall derive phase, progress, and status without legacy Markdown label matching.
