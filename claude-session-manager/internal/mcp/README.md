...
This package implements integration between AGM (claude-session-manager) and global MCP servers.
...
- [Temporal Workflow](~/src/ws/oss/repos/ai-tools/main/claude-session-manager/internal/temporal/workflows/mcp_service_workflow.go)
