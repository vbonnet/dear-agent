...
```go
import (
    "github.com/vbonnet/ai-tools/claude-session-manager/internal/astrocyte"
...
2. Verify watcher started successfully:
   ```
   ✓ Astrocyte watcher started (file: /home/user/.agm/astrocyte/incidents.jsonl, window: 15m0s)
   ```
