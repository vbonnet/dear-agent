...
type Workflow interface {
	...
	// SupportedAgents returns the list of agent names that support this workflow.
	// Example: []string{"gemini"} means only Gemini agent supports this workflow.
...
type WorkflowContext struct {
	// Agent is the AI agent to use for this workflow.
	// Required.
	Agent agent.Agent
