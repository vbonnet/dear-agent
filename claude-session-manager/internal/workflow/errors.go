...
// ErrWorkflowNotSupported indicates the workflow doesn't support the specified agent.
...
func (e ErrWorkflowNotSupported) Error() string {
	return fmt.Sprintf("workflow '%s' not supported by agent '%s'",
		e.WorkflowName, e.AgentName)
}
