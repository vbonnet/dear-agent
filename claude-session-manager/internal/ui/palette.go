...
type Palette struct {
	...
	Stale   lipgloss.Color // Stale/error sessions (red)
...
// - ANSI 9 (Bright Red): Stale/Error - 11.79:1 contrast ratio
...
func DefaultPalette() Palette {
	return Palette{
		...
		Stopped: lipgloss.Color("11"), // Bright Yellow (19.56:1)
		Stale:   lipgloss.Color("9"),  // Bright Red (11.79:1)
...
// - ANSI 1 (Red): Stale/Error - 5.25:1 contrast ratio
...
func LightPalette() Palette {
	return Palette{
		...
		Stale:   lipgloss.Color("1"), // Red (5.25:1)
