...
// Example: 1738612345678-csm-send-001
//
// Properties:
//   - Short: ~25-30 chars
...
func (g *MessageIDGenerator) Next() (string, error) {
	...
	// Persist sequence to disk (async to avoid blocking)
	// Note: We accept small risk of sequence reset on crash for performance
	// Timestamp provides uniqueness guarantee anyway
	go g.saveSequence()
