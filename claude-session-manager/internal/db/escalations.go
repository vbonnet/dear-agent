...
// EscalationEvent is an alias for the activities.EscalationEvent type
// We use this in the database layer to avoid importing temporal activities everywhere
type EscalationEvent = activities.EscalationEvent
