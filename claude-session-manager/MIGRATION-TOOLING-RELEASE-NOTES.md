...
- Agent not available → Installation verification
...
```bash
# csm commands still work (backward compatible)
csm list
...
File issues at: https://github.com/vbonnet/ai-tools/issues
...
**Support**: https://github.com/vbonnet/ai-tools/issues
