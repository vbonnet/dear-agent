...
**Location**: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/AGM-COMMAND-REFERENCE.md`
...
**Location**: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/AGM-QUICK-REFERENCE.md`

### 2. Enhanced Command Help Text

#### csm send
**File**: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/cmd/csm/send.go`
...
#### csm reject
**File**: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/cmd/csm/reject.go`
...
**File**: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/README.md`
