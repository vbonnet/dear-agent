...
agm new --agent gemini research-ai-papers
...
```bash
agm send <session> --prompt "text"    # Send message to session
agm reject <session> --reason "..."   # Reject permission prompt
```
...
**Problem:** "Agent not configured" error
