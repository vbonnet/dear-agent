...
# Or browse online
open https://github.com/vbonnet/ai-tools/blob/main/claude-session-manager/docs/AGM-MIGRATION-GUIDE.md
```
...
agm new --agent gpt brainstorming
```
...
agm new test-migration --agent claude
...
agm new test-migration --agent gemini
...
3. **File issue**:
   - URL: https://github.com/vbonnet/ai-tools/issues
