...
**Impact**:
- **Before**: `agm session new --agent=claude --detached` would hang for 30 seconds and fail
...
```
$ agm session new test-session --agent=claude --detached
Creating session...
...
**Location**: ~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/ARCHITECTURE.md
...
**Location**: ~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/adr/0001-init-sequence-capture-pane.md
...
**Location**: ~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/adr/0002-init-sequence-timing-and-locking.md
...
**Location**: ~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/adr/README.md
...
**Location**: ~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/testing/INIT_SEQUENCE_TEST_COVERAGE.md
...
**Command**:
```bash
$ agm session new post-restart-test --agent=claude --detached
```
