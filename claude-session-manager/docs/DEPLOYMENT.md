...
agm new test-session --agent claude
...
```bash
# Create test session
agm new test-workflow-session --agent claude --project /tmp/test
...
```bash
# 1. Create session
agm new sample-session --agent claude --project ~/projects/test
...
1. **Check documentation**:
   - AGM: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/`
...
4. **Report issues**:
   - GitHub: https://github.com/vbonnet/ai-tools/issues
...
1. **Configure Production Settings**:
   ...
   - See: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/AGM-DEPLOYMENT.md`
...
3. **Security Hardening**:
   ...
   - See: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/AGM-SECURITY.md`
