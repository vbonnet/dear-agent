...
```bash
cd ~/src/ws/oss/swarm/projects/mcp-global-sharing/packages/mcp-http-server
...
- Full Documentation: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/internal/mcp/README.md`
- Implementation Details: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/docs/global-mcp-integration.md`
- Example Config: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/internal/mcp/example-config.yaml`
- MCP HTTP Server: `~/src/ws/oss/swarm/projects/mcp-global-sharing/packages/mcp-http-server/README.md`
