...
AGM supports multiple AI agents (Claude, Gemini, GPT) with automatic routing based on keywords.
...
schema_version: "1.0"
default_agent: "claude"        # Fallback agent: claude, gemini, or gpt
...
preferences:
  ...
  - keywords:
      - "research"
      - "analysis"
    agent: "gemini"            # Use Gemini for research tasks
```
