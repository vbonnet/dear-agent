...
# Create with agent
agm new --agent claude   code-task      # Code, reasoning
agm new --agent gemini   research       # Research, 1M context
agm new --agent gpt      brainstorm     # Chat, ideas
```
...
agm unarchive *[REDACTED_EMPLOYER]*      # Pattern matching
...
# Workflows
agm workflow list
agm new --agent gemini --workflow deep-research url-task
