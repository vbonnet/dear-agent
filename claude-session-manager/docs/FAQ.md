...
**Repository:** https://github.com/vbonnet/ai-tools/tree/main/claude-session-manager
...
agm new --agent gemini research-task --project ~/research
```
...
agm new --agent gemini myapp-research --project ~/projects/myapp

# Implementation with Claude
agm new --agent claude myapp-code --project ~/projects/myapp

# Quick questions with GPT
agm new --agent gpt myapp-questions --project ~/projects/myapp
```
...
**Current workaround:** Use explicit `--agent` flag
...
0 2 * * 0 /home/user/scripts/weekly-cleanup.sh
```
