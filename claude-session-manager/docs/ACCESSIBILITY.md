...
CSM_SCREEN_READER=1 csm list

# Or via config file (~/.config/csm/config.yaml)
ui:
  screen_reader: true
```
...
ui:
  theme: "csm"        # Dark terminal (default)
  # theme: "csm-light" # Light terminal
  # theme: "dracula"   # Legacy Dracula theme
  # theme: "base"      # Minimal theme
```

**Available themes:**
- `csm`: High-contrast for dark terminals (default)
...
1. **Auto theme detection**: Detect terminal background color and choose csm/csm-light automatically
