...
phase_engram_path: "~/src/ws/oss/repos/engram/main/plugins/wayfinder/engrams/workflows/s11-retrospective.ai.md"
---
...
**What Evolved:**
- Understanding → pkg/progress is in engram repo, not claude-session-manager repo
