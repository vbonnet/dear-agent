...
phase_engram_path: "~/src/ws/oss/repos/engram/main/plugins/wayfinder/engrams/workflows/s7-plan.ai.md"
---
...
**Steps**:
1. Navigate to `~/src/ws/oss/repos/engram/main/core/pkg/progress/`
2. List files (`ls -la`)
...
**External**:
- Access to `~/src/ws/oss/repos/engram/main/core/pkg/progress/`
