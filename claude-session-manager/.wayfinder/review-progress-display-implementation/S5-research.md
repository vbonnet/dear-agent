...
phase_engram_path: "~/src/ws/oss/repos/engram/main/plugins/wayfinder/engrams/workflows/s5-research.ai.md"
---
...
**Path**: `~/src/ws/oss/repos/engram/main/core/pkg/progress/`
**Note**: Not in claude-session-manager repo (different project)
