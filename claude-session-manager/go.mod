...
require (
	...
	github.com/vbonnet/engram/core v0.0.0-00010101000000-000000000000
...
// Local development: use local engram repo
replace github.com/vbonnet/engram/core => ../../../engram/core
