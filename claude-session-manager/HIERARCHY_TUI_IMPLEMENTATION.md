...
### Created:
1. `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/internal/ui/hierarchy.go` (458 lines)
...
2. `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/internal/ui/hierarchy_test.go` (539 lines)
   - 15 test functions covering all rendering scenarios
   - Mock tmux interface for testing
   - Tests for all layout modes

3. `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/test_hierarchy.sh`
   - Automated test runner with coverage reports

### Modified:
1. `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/internal/db/hierarchy.go`
   - Added `SessionNode` struct
   - Added `GetAllSessionsHierarchy()` function (88 lines)

2. `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/internal/db/hierarchy_test.go`
   - Added `TestGetAllSessionsHierarchy()` with 8 subtests (192 lines)

3. `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/cmd/agm/list.go`
