...
phase_engram_path: "~/src/ws/oss/repos/engram/main/plugins/wayfinder/engrams/workflows/d1-problem-validation.ai.md"
---
...
- ❌ No systematic verification that `csm new --agent=gemini` matches `csm new --agent=claude`
...
2. ✅ Tests run successfully for both `--agent=claude` and `--agent=gemini`
