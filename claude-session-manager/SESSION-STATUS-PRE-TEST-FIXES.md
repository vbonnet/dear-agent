...
**Root Cause Found**: Astrocyte daemon was calling non-existent `csm send` command, causing subprocess errors that interfered with tmux state.
...
- ✅ Deleted old csm binaries (/home/user/go/bin/csm*)
...
**Location**: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/internal/tmux/send_command_test.go:25`
...
**Stack Trace**:
```
github.com/vbonnet/ai-tools/claude-session-manager/internal/readiness.WaitForReady
...
**Test File**: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/test/e2e/testdata/session-listing.txtar`
...
**Test File**: `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/test/bdd/features/session_association.feature`
...
**Wayfinder Project**: Located at `~/src/ws/oss/repos/ai-tools/main/claude-session-manager/wayfinder-projects/`
...
```bash
# TMux test
go test -C ~/src/ws/oss/repos/ai-tools/main/claude-session-manager ./internal/tmux -v -run TestSendCommand_EnterKeySeparation

# E2E test
go test -C ~/src/ws/oss/repos/ai-tools/main/claude-session-manager ./test/e2e -v -run session-listing

# BDD test
go test -C ~/src/ws/oss/repos/ai-tools/main/claude-session-manager ./test/bdd -v
```
