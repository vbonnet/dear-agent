...
**Location**: `/home/user/src/ws/oss/repos/ai-tools/main/claude-session-manager/test/integration/lifecycle/comprehensive_session_lifecycle_test.go`
...
**Location**: `/home/user/src/ws/oss/repos/ai-tools/main/claude-session-manager/test/integration/lifecycle/SESSION_LIFECYCLE_TEST_COVERAGE.md`
