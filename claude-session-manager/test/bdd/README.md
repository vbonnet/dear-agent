...
import (
    ...
    "claude-session-manager/test/bdd/internal/testenv"
)
...
- Main README: ~/src/ws/oss/repos/ai-tools/main/claude-session-manager/README.md
- Wayfinder project documentation: /home/user/src/ws/oss/wf/bdd-test-suite-expansion/
