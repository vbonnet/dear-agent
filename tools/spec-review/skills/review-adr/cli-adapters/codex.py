#!/usr/bin/env python3
"""Codex adapter for review-adr skill.
Optimized for Codex CLI with completion mode.
"""
...
def optimize_for_codex(validator: ADRValidator):
    """Codex specific optimizations."""

    # Codex uses completion mode
    # Smaller batch sizes for completion-based evaluation

    return {
        "use_completion_mode": True,
        "batch_size": 5
    }


def run_validation(adr_file: str, output_format: str = "markdown"):
    """Run ADR validation optimized for Codex."""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Review ADR (Codex)")
