...
**STRUCT-HEALTH-01** When structural scans run, the system shall execute the canonical dead-package, file-size, zero-test, doc-path, and goroutine-recover scans.
