...
**RESOLVE-REVIEW-THREADS-80** When a reply could create an outstanding continuation obligation, the system shall establish private, durable, and stable local issuer state before posting and shall fail before provider mutation when that state cannot be safely established or verified for later continuation.
