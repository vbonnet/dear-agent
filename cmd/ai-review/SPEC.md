...
- The command classifies only the Git shape of a possible
  ...
  authenticates Dependabot's immutable bot identity, numeric head-repository
  identity, exact current commit and parent, and current-head timeline
